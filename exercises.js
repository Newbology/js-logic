...
function spareChange(money){
  if(money >= 100){
    return true + " get money cuz";
  }else{
    return false + " we no money cuz";
  }
}
console.log(spareChange(398712639786));
...
function dirty30(one, two, three){
  ...
  if(sum > 30){
    return true +' dirty 30';
  }else{
    return false + ' dirty dan';
  }
}
console.log(dirty30(6, 9, 54));
...
function graduation(credits, thesis){
  if(credits >= 120 || thesis === true){
    ...
    return "see you in summer school opposite of nerd."
  }
}
...
function moneyTrain(speed){
  ...
  return "you are riding honolulu's rail."
    ...
    return "you are not riding honolulu's rail."
  }else{ 
   return "now you ballin in the cyka blyat."
  }
}
console.log(moneyTrain(64));
/*
 * #14
...
function buyDoughnut(){
  ...
  budget -= doughnutPrice; //doughtnut
  doughnutBought++;
  }
}
buyDoughnut();
...
function breakfastMenu(meal){
  switch (meal) {
  case 'monday':
    menu = 'eggs and rice.';
    break;
  case 'tuesday':
    menu = 'sausage and biscuits.';
    break;
  case 'wednesday':
  ...
  case 'thursday':
    ...
    break;
  case 'friday':
    menu = 'nothing cuz no one even eats here.';
    break;
}
  return menu;
}
console.log(breakfastMenu('thursday'));
/*
...
/* 
 * #15vvvvvvvvvvvvvvvvvvvvvvvvvvvv
...
*/
 ...
 for (var i=0; i<myFavFoods.length; i++){
   console.log('Fave Food for now '+myFavFoods[i]);
 }
